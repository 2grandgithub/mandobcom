...
@component('components.panel_default_with_blank')
    @slot('active') Recycable @endslot
    @slot('page_title') @lang('page.Recycable')  @endslot
    @slot('panel_title') @lang('page.Recycable') @endslot
    ...
    @slot('script')
        <script>
            var delete_api = '{{url('Recycable/delete')}}';
            var get_list = '{{url('Recycable/list')}}';
            var showORhide_api = '{{url('Recycable/showORhide')}}';
            var accaptedORunAccapted_api = '{{url('Recycable/accaptedORunAccapted')}}';
            var create_api = '{{url('Recycable/create')}}';
            var update_api = '{{url('Recycable/update')}}';
        </script>
