...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"> @lang('page.create Admin') </h3>
      ...
      <div class="panel-body">
        ...
        {!! Form::model($admin= new \App\Admin,['url'=>'Admin','id'=>'create_form']) !!}
        ...
        <div class="row">
            <div class="col-md-6">
                  ...
                  {!! Form::password('password',['class'=>'form-control','id'=>'password','minlength'=>'6','required']) !!}

                  {!! Form::label('password_again',__('page.password again')) !!}
                  {!! Form::password('password_again',['class'=>'form-control','id'=>'password_again','required','minlength'=>'6']) !!}
