...
@section('script')
    ...
    <script>
        ...
        @elseif($type == 'Recycable')
            var api_get_chat_users = '{{url('Chat/get_chat_users_type_Recycable')}}';
        @elseif($type == 'ProducerFamily')
            var api_get_chat_users = '{{url('Chat/get_chat_users_type_ProducerFamily')}}';
        @endif
