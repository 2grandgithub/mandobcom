...
@component('components.panel_default_with_blank')
    @slot('active') Buyer @endslot
    @slot('page_title') @lang('page.Buyer')  @endslot
    @slot('panel_title') @lang('page.Buyer') @endslot
    ...
    @slot('script')
        <script>
            var delete_api = '{{url('Buyer/delete')}}';
            var get_list = '{{url('Buyer/list')}}';
            var showORhide_api = '{{url('Buyer/showORhide')}}';
            var accaptedORunAccapted_api = '{{url('Buyer/accaptedORunAccapted')}}';
            var create_api = '{{url('Buyer/create')}}';
            var update_api = '{{url('Buyer/update')}}';
        </script>
