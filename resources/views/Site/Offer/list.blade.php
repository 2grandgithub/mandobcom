            ...
            <div class="checkbox checkbox-primary">
              ...
              <ul>
                <li v-for="(company,index) in filteredcompanies">
                  <input :id="'brand'+index" :value="company.id" class="styled inp_company" type="checkbox" name="companies_fillter[]" v-on:change="getResults" >
        ...
        <div class="col-md-9">
            ...
            <ul>
              ...
              <li>
                <select class="selectpicker" id="sort" v-on:change="getResults">
                    ...
                    <option value="views"> @lang('page.Sort by views') </option>
          ...
          <div :class="{'item-col-3':view_type=='card', 'col-list':view_type=='list'}">
            ...
            <div class="product"  v-for="list in mainList.data" v-show="view_type=='card'">
              <article>
                <img class="img-responsive" :src="list.image.split(',')[0]" style=" width: 242px; height: 242px;"> <!-- <span class="sale-tag">-25%</span>--> <span>
                   <span class="new-tag" v-if="list.is_new" >  @lang('page.new') </span> 
                <!-- Content -->
                <span class="tag"> @{{list.sub_category_name}} </span> <a :href="'{{url('Site/offer/details')}}/'+list.offer_id" class="tittle"> @{{list.offer_name}} </a>
                <!-- Reviews -->
                <p class="rev">
                ...
                <div class="price">   <span>@{{list.old_price}} @lang('page.JD')</span>  @{{list.new_price}} @lang('page.JD') </div>
                    ...
                    <div class="col-sm-5 text-center">
                      {{-- <a href="#." class="heart"><i class="fa fa-heart"></i></a> <a href="#." class="heart navi"><i class="fa fa-navicon"></i></a> --}}
                        <div class="position-center-center">
                            ...
                            <p>@lang('page.likes'):  <span class="in-stock">@{{list.likes}}</span></p>
...
@section('script')
    ...
    <script src="{{asset('js_site/Offer.js')}}"> </script>
@endsection
