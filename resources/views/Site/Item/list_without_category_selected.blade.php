        ...
        <div class="col-md-3">
          <div class="shop-side-bar">
            ...
            <div class="checkbox checkbox-primary">
                 ...
                 <ul>
                     <li>
                        <a  href="{{url('Site/Category/item')}}">  <label   > @lang('page.all') </label>  </a>
                      </li>
                     <li v-for="(cat,index) in filteredCategory" >
                         <a :href="category_url(cat.value)">  <label  > @{{cat.label}} </label>  </a>
                     </li>
                 </ul>
            </div>
...
@section('script')
    ...
    <script src="{{asset('js_site/items_without_category_selected.js')}}"> </script>
@endsection
