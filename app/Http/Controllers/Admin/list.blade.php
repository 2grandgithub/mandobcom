      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <div class="shop-side-bar">
            ...
            <br>
            <button class="btn-round" v-on:click="getResults">Filter</button>
            ...
            <div class="product"  v-for="list in mainList.data" v-show="view_type=='card'">
              <article>
                ...
                <p class="rev">
                  ...
                  <span class="margin-left-10"> @{{list.views}} views(s) </span>
                </p>
                <div class="price"> @{{list.price}} JD <!--<span>$200.00</span>--> </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      ...
                      <p class="rev">
                        <i class="fa fa-star" v-for="n in (list.stars) " ></i>
                        <i class="fa fa-star-o" v-for="n in (5-list.stars)" ></i>
                      <span class="margin-left-10"> @{{list.views}} views(s)</span></p>
                    ...
                    <div class="col-sm-5 text-center">
                      {{-- <a href="#." class="heart"><i class="fa fa-heart"></i></a> <a href="#." class="heart navi"><i class="fa fa-navicon"></i></a> --}}
                        <div class="position-center-center">
                            <div class="price">@{{list.price}} JD</div>
