...
class MyAuctionRequestController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Company.MyAuctionRequest.index',compact('Category'));
    }
    ...
    public function payment($id)
    {
        ...
        $AuctionRequest = AuctionRequest::select('auction_requests.*','categories.name_'.$lang.' as category_name',
             'buyers.name as buyer_name','companies.name_'.$lang.' as company_name','companies.id as company_id','from','to')
        ->where('auction_requests.id', $id )
        ->where('companies.id', auth('Company')->id() )
        ...
        ->latest('auction_requests.id')->first();
        $Offer = AuctionOffer::select('auction_offers.*','companies.name_'.$lang.' as company_name','companies.phone as company_phone')
                    ->where('auction_offers.id',$AuctionRequest->winner_offer_id)
                    ->join('companies','companies.id','auction_offers.company_id')
                    ->groupBy('auction_offers.id')
                    ->orderBy('auction_offers.price_offer')
                    ->first();
        ...
        return view('Company.MyAuctionRequest.payment',compact('AuctionRequest','Offer'));
    }
