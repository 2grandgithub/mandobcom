...
class HomeController extends Controller
{
      ...
      public function index()
      {
          ...
          $Setting = \App\Setting::where('title','main_page_image1_beside_slider')->orWhere('title','main_page_image2_beside_slider')
                    ->pluck('value','title');
          ...
          return view('Site.Home',compact('categoiry_id','data','Setting'));
      }
      ...
      public function items_list()
      {
           ...
           $datetime_After_weak_later = \Carbon\Carbon::now()->addDays(7)->toDateTimeString();
           ...
           $items = Item::select('items.name_'.$lang.' as item_name','items.id as item_id','items.description_'.$lang.' as item_description',
                          ...
                          'categories.name_'.$lang.' as category_name','sub_categories.name_'.$lang.' as sub_category_name', 'items.created_at as created_at',
                   ...
                   \DB::raw("if( DATEDIFF( now() , items.created_at ) <= 7 , 1,0 ) as is_new")
                 )
