...
{
    public partial class frmFetchOffices : Form
    {
        public frmFetchOffices()
        {
            InitializeComponent();
        }
        ...
        {
            LocationReference.OfficesFetchingRequest _Request = new LocationReference.OfficesFetchingRequest();
            ...
            try
            {
                ...
                dynamic _Response = _Client.FetchOffices(_Request);
