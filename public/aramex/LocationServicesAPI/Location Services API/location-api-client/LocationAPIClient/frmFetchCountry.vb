Public Class frmFetchCountry
    ...
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        Dim _Request As New LocationReference.CountryFetchingRequest()
        ...
        Try
            ...
            Dim _Response = _Client.FetchCountry(_Request)

            dgvErrors.DataSource = _Response.Notifications
            dgvCountries.DataSource = New List(Of LocationReference.Country)({_Response.Country})
